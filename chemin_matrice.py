...
def trouver_chemin(matrice):
    ...
    # return point_depart, position_depart, dict_chemin

    def trouver_prochain_point():
        ...
        return trouver_prochain_point(prochain_point, position_prochain_point, dict_chemin)
    print(dict_chemin)
